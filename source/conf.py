...
project = u'sphinx-docs'
copyright = u'2020, Jason'
author = u'Jason'
...
htmlhelp_basename = 'sphinx-docsdoc'
...
latex_documents = [
    (master_doc, 'sphinx-docs.tex', u'sphinx-docs Documentation',
     u'Jason', 'manual'),
]
...
man_pages = [
    (master_doc, 'sphinx-docs', u'sphinx-docs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphinx-docs', u'sphinx-docs Documentation',
     author, 'sphinx-docs', 'One line description of project.',
     'Miscellaneous'),
]
